...
% IDVT0          -  the starting time of disturbances, 1 by 28 matrix
% IDVT1          -  the end time of disturbances, 1 by 28 matrix
% IDVAmplitude   -  the amplitudes of the distrubances, 1 by 28 matrix

IDVT0=zeros(1,28);
IDVT1=zeros(1,28);
IDVAmplitude=zeros(1,28);
